...
public class TutorialContentTypes extends ARViewActivity 
{
	...
	protected void loadContents() 
	{
		try
		{
			...
			final String modelPath = AssetsManager.getAssetPath(getApplicationContext(), "TutorialContentTypes/Assets/metaioman.md2");			
			if (modelPath != null) 
			{
			...
			final String moviePath = AssetsManager.getAssetPath(getApplicationContext(), "TutorialContentTypes/Assets/demo_movie.3g2");
			if (moviePath != null)
			{
			...
			final String truckPath = AssetsManager.getAssetPath(getApplicationContext(), "TutorialContentTypes/Assets/truck/truck.obj");
			if (truckPath != null)
			{
			...
			final String path = AssetsManager.getAssetPath(getApplicationContext(), "TutorialContentTypes/Assets/env_map.zip");
			if (path != null)
			{
